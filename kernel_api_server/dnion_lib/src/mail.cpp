...
//		return 0;
	...
	mail.mail_svrip = "mail.dnion.com";
	mail.mail_svrport = 25;
	mail.user = "fanxiushu"; mail.passwd ;//"1234506";

	mail.mail_from="fanxiushu@dnion.com";

	mail.rcpt_to.push_back("fanxiushu@dnion.com");
//	mail.rcpt_to.push_back("fanxiushu@163.com");
//	mail.rcpt_to.push_back("fanxiushu@sohu.com");
